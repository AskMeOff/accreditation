...
let idRkk;
let loginApp;
function newShowModal1(id_application) {
    let trthis = document.querySelector(`[onclick="newShowModal('${id_application}')"]`);
    console.log(trthis);
    console.log(trthis.closest('.tab-pane'));
    let newId = trthis.closest('.tab-pane').id + "-tab";
    document.getElementById(newId).click
    trthis.onclick(()=> newShowModal(id_application));

}

function newShowModal(id_application) {
    let trthis = document.querySelector(`[onclick="newShowModal('551')"]`);
  ///  console.log('trthis.click');
  //  trthis.onclick(()=>newShowModal('551'))
 //   console.log(trthis);
